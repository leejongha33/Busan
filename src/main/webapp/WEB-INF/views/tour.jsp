...
<body>
	...
	<div class="daddy">
		...
		<div class="top-outline">
            ...
            btn11.style.backgroundColor = '#ffffff';
            btn11.style.color = 'rgb(40, 158, 107)';
            ...
            btn31.style.backgroundColor = 'rgb(236, 97, 30)';
            btn31.style.color = '#ffffff';
         </script>
			...
			<div class="second-d">
				...
				<div class="sd-bottom">
					...
					<div class="map">
						<img src="img/check/busanmap.png"
							style="width: 800px; height: 350px;" id="mapsrc">
		...
		<div class="dataList">
			<c:forEach var="dto" items="${tourList }">
				<div class="dataDiv">
					<div>
						<a href="${cpath }/tourInfo/${dto.tname}/"> 
							<img src="${cpath }/uploadFile/tour/${dto.tpic}">
						</a>
					</div>
					<div class="dataName">${dto.tname }</div>
					<div class="dataAddr">
						<c:set var="taddr" value="${fn:split(dto.taddr,' ') }"></c:set>
						<c:forEach var="addr" items="${taddr }" begin="0" end="1">
                        ${addr }
                     </c:forEach>
					</div>
				</div>
...
const makeToList = function(json) {
      ...
      for(let i = 0; i < json.length; i++){
         ...
         div3.innerText = json[i].tname;
         div4.innerText = json[i].taddr.split(' ')[0];
         div4.innerText += ' '+ json[i].taddr.split(' ')[1];
         img.src = cpath + '/uploadFile/tour/' + json[i].tpic;
         a.href = cpath + '/tourInfo/' + json[i].tname + '/';
