...
<body>
			...
			<div class="wrap-in subWrap">
				<main id="contents">
					...
					<div class="conHeader">
						...
						<h3 class="title">${addr } - ${dto.tname }</h3>
					</div>
					...
					<div class="detailWrap">
						<div class="detailWrap-in">
							<div class="detailImg">
								<div>
									<img width="695px" height="500px"
										src="${cpath }/uploadFile/tour/${dto.tpic}">
								</div>
							</div>
							<div class="detailInfo" style="height: 500px">
								<dl>
									<dt>
										<span>주소</span>
									</dt>
								...
								<dl>
									...
									<dd>
										<span> <c:if test="${dto.tpnum == '0' }">

											</c:if> <c:if test="${dto.tpnum != '0' }">
                                           ${dto.tpnum }
                                        </c:if>
										</span>
									</dd>
								...
								<dl>
									...
									<dd>
										<span>${dto.topen } ~ ${dto.tclose }</span>
									</dd>
								</dl>
								<dl>
									<dt>
					...
					<div class="second-Wrap">
						<div class="second-Wrap-in">
							<div class="mapApi">
								<img src="${cpath }/img/map.png">
							</div>
							<div class="statement">
								<div class="statement-div">
									<div class="statement-div-div">연령별 / 성별 좋아요 비율</div>
							...
							<div class="review">
								<div class="review-div">
									...
									<form id="insertReview" method="POST">
										<input type="hidden" name="cftName" value="${dto.tname }">
	...
	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=642811871765a9a66658d5a108cbcf71&libraries=services"></script>
	<script type="text/javascript">

   var mapContainer = document.querySelector('.mapApi'); //지도를 담을 영역의 DOM 레퍼런스
   ...
   // 주소로 좌표를 검색합니다
   geocoder.addressSearch('${dto.taddr}', function(result, status) {
       ...
       // 정상적으로 검색이 완료됐으면 
        if (status === kakao.maps.services.Status.OK) {
           ...
           var infowindow = new kakao.maps.InfoWindow({
               content: '<div style="width:150px;text-align:center;padding:6px 0;border-radius:50%;text-weight: bold;">'+'${dto.tname}'+'</div>'
           });
         ...
         if(userid == ''){
            ...
            .then(text => {
               if(text == 1){
                  alert('댓글이 등록되었습니다');
                  content.value = '';
                  location.href = '${cpath}/tourInfo/${dto.tname}/';
               }
            })
         }
      }
